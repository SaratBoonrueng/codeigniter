 ...
 */
class CatalogProductVirtual extends \Magento\Mtf\Fixture\InjectableFixture
{
    /**
     * @var string
     */
    protected $repositoryClass = 'Mage\Catalog\Test\Repository\CatalogProductVirtual';

    /**
     * @var string
     */
    protected $handlerInterface = 'Mage\Catalog\Test\Handler\CatalogProductVirtual\CatalogProductVirtualInterface';
    ...
    protected $price = [
        ...
        'repository' => 'Mage\Catalog\Test\Repository\CatalogProductVirtual\Price',
    ];
    ...
    protected $checkout_data = [
        'group' => 'null',
        'repository' => 'Mage\Catalog\Test\Repository\CatalogProductVirtual\CheckoutData',
    ];
